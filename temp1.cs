...
public class VideoPlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        videoDirectory = Path.Combine("/home/mobisec/Desktop/optiplex/pensive-PyTorch-Temp/temp", "Videos");
    ...
    private IEnumerator PlayNextVideo(VideoPlayer videoPlayer, RenderTexture renderTexture)
    {
        ...
        string filePath = Path.Combine("/home/mobisec/Desktop/optiplex/pensive-PyTorch-Temp/temp/Videos", "segment" + segmentNumber + ".mp4");
    ...
    private IEnumerator PrepareNextSegment(VideoPlayer currentVideoPlayer)
    {
        ...
        string nextFilePath = Path.Combine("/home/mobisec/Desktop/optiplex/pensive-PyTorch-Temp/temp/Videos", "segment" + segmentNumber + ".mp4");
...
//         if (videoPlayer == videoPlayer1)
//         {
//             videoPrepared(videoPlayer2);
//         }
//         else
//         {
//             videoPrepared(videoPlayer1);
//         }
//     }
// }
